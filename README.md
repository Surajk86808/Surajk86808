...
I design and ship **production AI systems** — multi-agent orchestration, RAG pipelines, and backend infrastructure that run unattended in real environments, not notebooks.

Currently completing a **BS in Data Science & Applications at IIT Madras** (2027) alongside a B.Tech in Computer Science, based in Bengaluru, India.
...
![FAISS](https://img.shields.io/badge/FAISS-4B5563?style=for-the-badge&logoColor=white)
...
![ARQ](https://img.shields.io/badge/ARQ-4B5563?style=for-the-badge&logoColor=white)
![BullMQ](https://img.shields.io/badge/BullMQ-DD2C00?style=for-the-badge&logoColor=white)
...
<!-- dynamic 31-day activity graph, no workflow required -->
<img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=Surajk86808&theme=tokyo-night&hide_border=true&bg_color=0d1117" />
...
<img width="100%" src="https://raw.githubusercontent.com/Surajk86808/Surajk86808/main/profile-3d-contrib/profile-night-rainbow.svg" />

</div>

> **One-time setup (~2 min):** the snake and 3D contribution graphics above render once their workflow files run for the first time — `.github/workflows/snake.yml` and `.github/workflows/profile-3d.yml`. Both run nightly on a schedule and can also be triggered manually from the **Actions** tab (`Run workflow`). The activity graph above needs no workflow — it's rendered live on every page load.

---

## Currently Building

- Expanding multi-agent agentic workflows and token-efficiency tuning across long-running LLM sessions
- Production hardening of automated browser resilience and large-scale automation pipelines
